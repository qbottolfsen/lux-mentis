...
**87.6% of SNFs nationally (12,868 of 14,695) would not have met CMS-3442-F's final-state four-part staffing standards** (RN HPRD ≥ 0.55, Weekend RN HPRD ≥ 0.55, Nurse Aide HPRD ≥ 2.45, Total Nurse HPRD ≥ 3.48). All thresholds apply to `reported_*` (unadjusted PBJ) HPRD — confirmed by rule text specifying enforcement independent of case-mix. *(Level 1 — counterfactual; see [CORRECTIONS.md](CORRECTIONS.md) for prior formula error and correction history)*
